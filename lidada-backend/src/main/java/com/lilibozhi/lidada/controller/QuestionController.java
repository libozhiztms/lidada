...
import com.lilibozhi.lidada.manager.AiManager;
import com.lilibozhi.lidada.model.dto.question.*;
import com.lilibozhi.lidada.model.entity.App;
import com.lilibozhi.lidada.model.entity.Question;
import com.lilibozhi.lidada.model.entity.User;
import com.lilibozhi.lidada.model.enums.AppTypeEnum;
import com.lilibozhi.lidada.model.vo.QuestionVO;
import com.lilibozhi.lidada.service.AppService;
import com.lilibozhi.lidada.service.QuestionService;
...
public class QuestionController {
    ...
    public SseEmitter aiGenerateQuestionSSE(AiGenerateQuestionRequest aiGenerateQuestionRequest) {
        ...
        modelDataFlowable
                ...
                .map(modelData -> modelData.getChoices().get(0).getDelta().getContent()) //取到数据
                .map(message -> message.replaceAll("\\s", "")) //将空白字符变成空字符
                .filter(StrUtil::isNotBlank)//只保留非空
                .flatMap(message -> {
                    //将一条完整字符串的流分成多个流使得每个流只有一个字符
